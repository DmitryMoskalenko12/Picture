...
/* harmony import */ var core_js_modules_es_object_from_entries__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! core-js/modules/es.object.from-entries */ "./node_modules/core-js/modules/es.object.from-entries.js");
/* harmony import */ var core_js_modules_es_object_from_entries__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_from_entries__WEBPACK_IMPORTED_MODULE_3__);
...
function drop() {
  var files = document.querySelectorAll('[name="upload"]');
  ['dragenter', 'dragleave', 'dragover', 'drop'].forEach(function (eventD) {
  ...
  ['dragenter', 'dragover'].forEach(function (eventD) {
    files.forEach(function (input) {
      input.addEventListener(eventD, function () {
        return areaColor(input);
      }, false);
    });
  });
  ['dragleave', 'drop'].forEach(function (eventD) {
    files.forEach(function (input) {
      input.addEventListener(eventD, function () {
        return noAreaColor(input);
      }, false);
    });
  });
...
function forms(price) {
  ...
  function bindForm(form) {
    form.addEventListener('submit', function (e) {
      ...
      var json = JSON.stringify(Object.fromEntries(formData.entries()));
      postData(path, json).then(function () {
...
function modal() {
  ...
  function bindModal(trigger, modal, close) {
    ...
    modalTrigger.forEach(function (trig) {
    ...
    function scroll() {
      ...
      var res = div.offsetWidth - div.clientWidth;
      div.remove();
      return res;
    }
...
/***/ "./src/js/modules/showNextCard.js":
/*!****************************************!*\
  !*** ./src/js/modules/showNextCard.js ***!
  \****************************************/
/*! exports provided: default */
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            throw new Error("Error in path ".concat(url, " status: ").concat(res.status));
